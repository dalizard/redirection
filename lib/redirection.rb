...
ActionController::Base.send :include, Redirection::ControllerMethods
ActionView::Helpers.send :include, Redirection::Helpers
ActionView::Base.send :include, Redirection::Helpers
